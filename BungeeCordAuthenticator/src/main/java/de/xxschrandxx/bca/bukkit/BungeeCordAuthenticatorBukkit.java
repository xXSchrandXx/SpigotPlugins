...
public class BungeeCordAuthenticatorBukkit extends JavaPlugin {
  ...
  public void onEnable() {
    ...
    getServer().getMessenger().registerIncomingPluginChannel(this, "bungeeauth:login", new BCABPluginMessageListener(this));
    getServer().getMessenger().registerIncomingPluginChannel(this, "bungeeauth:logout", new BCABPluginMessageListener(this));
    getServer().getMessenger().registerOutgoingPluginChannel(this, "bungeeauth:sync");
    getServer().getMessenger().registerIncomingPluginChannel(this, "bungeeauth:sync", new BCABPluginMessageListener(this));
