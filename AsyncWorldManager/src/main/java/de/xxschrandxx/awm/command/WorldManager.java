...
public class WorldManager implements CommandExecutor, TabCompleter {
      ...
      if (args.length != 0) {
        if (args[0].equalsIgnoreCase("create")) {
          if (!Create.createcmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.create.usage")));
          }
          return true;
        }
        else if (args[0].equalsIgnoreCase("import")) {
          if (!Import.importcmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.import.usage")));
          }
          return true;
        }
        else if (args[0].equalsIgnoreCase("delete")) {
          if (!Delete.deletecmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.delete.usage")));
          }
          return true;
        }
        else if (args[0].equalsIgnoreCase("remove")) {
          if (!Remove.removecmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.remove.usage")));
          }
          return true;
        }
          ...
          if (!Teleport.teleportcmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.teleport.usage")));
          }
          return true;
        }
          ...
          if (!Listt.listcmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.list.usage")));
          }
          return true;
        }
        else if (args[0].equalsIgnoreCase("load")) {
          if (!Load.loadcmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.load.usage")));
          }
          return true;
        }
        else if (args[0].equalsIgnoreCase("unload")) {
          if (!Unload.unloadcmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.unload.usage")));
          }
          return true;
        }
        else if (args[0].equalsIgnoreCase("modify")) {
          if (!Modify.modifycmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.modify.usage")));
          }
          return true;
        }
        else if (args[0].equalsIgnoreCase("reload")) {
          if (!Reload.reloadcmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.reload.usage")));
          }
          return true;
        }
        else if (args[0].equalsIgnoreCase("plugin")) {
          if (!Plugin.plugincmd(sender, args)) {
            sender.sendMessage(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("command.plugin.usage")));
          }
          return true;
        }
        else {
  ...
  private void mainMSG(CommandSender sender) {
    if (hasPermission(sender, "command.permissions.worldmanager.main")) {
      sender.sendMessage(Main.Loop(Main.messages.get().getString("command.Main.head")));
      if (hasPermission(sender, "command.permissions.worldmanager.create"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.create.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm create ")).create());
      if (hasPermission(sender, "command.permissions.worldmanager.delete"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.delete.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm delete ")).create());
      if (hasPermission(sender, "command.permissions.worldmanager.import"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.import.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm import ")).create());
      if (hasPermission(sender, "command.permissions.worldmanager.remove"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.remove.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm remove ")).create());
      if (hasPermission(sender, "command.permissions.worldmanager.load"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.load.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm load ")).create());
      if (hasPermission(sender, "command.permissions.worldmanager.unload"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.unload.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm unload ")).create());
      if (hasPermission(sender, "command.permissions.worldmanager.teleport.main"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.teleport.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm tp ")).create());
      if (hasPermission(sender, "command.permissions.worldmanager.info"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.info.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm info ")).create());
      if (hasPermission(sender, "command.permissions.worldmanager.list"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.list.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm list")).create());
      if (hasPermission(sender, "command.permissions.worldmanager.modify.main"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.modify.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm modify ")).create());
      if (hasPermission(sender, "command.permissions.worldmanager.reload"))
        sender.spigot().sendMessage(new ComponentBuilder(Main.Loop("&8| &7" + Main.messages.get().getString("command.reload.usage"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop(Main.messages.get().getString("command.Main.hover"))).create())).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/wm reload")).create());
      sender.sendMessage(Main.Loop(Main.messages.get().getString("command.Main.head")));
    }
    else {
      sender.spigot().sendMessage(new ComponentBuilder(Main.Loop(Main.messages.get().getString("prefix") + Main.messages.get().getString("nopermission"))).event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(Main.Loop("(Required: &e%perm%&7)").replace("%perm%", Main.config.get().getString("command.permissions.worldmanager.main"))).create())).create());
  ...
  public static boolean hasPermission(CommandSender sender, String path) {
    if (sender instanceof Player) {
      ...
      if (p.hasPermission(Main.config.get().getString(path))) {
        return true;
      }
      else {
        return false;
